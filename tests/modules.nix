...
let
  ...
  tests = runTests {
    testDuplicateRootDirectories = checkAssertionsMatch "The following directories were specified two or more[^a-z]*times" {
    ...
    testDuplicateRootFiles = checkAssertionsMatch "The following files were specified two or more[^a-z]*times" {
      environment.persistence = {
        "/abc".files = [ "/same/file" ];
        "/def".files = [ "/same/file" ];
      };
    ...
    testDuplicateUserDirectories = checkAssertionsMatch "The following directories were specified two or more[^a-z]*times" {
    ...
    testDuplicateUserFiles = checkAssertionsMatch "The following files were specified two or more[^a-z]*times" {
      users.users.auser.isNormalUser = true;
      environment.persistence = {
